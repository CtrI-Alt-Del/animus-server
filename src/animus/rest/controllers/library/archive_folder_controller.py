...
from animus.core.library.use_cases import ArchiveFolderUseCase
...
class ArchiveFolderController:
    ...
    def handle(router: APIRouter) -> None:
        ...
        def _(
            ...
            use_case = ArchiveFolderUseCase(folders_repository=folders_repository)
