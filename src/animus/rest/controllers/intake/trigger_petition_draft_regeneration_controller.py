...
class TriggerPetitionDraftRegenerationController:
    @staticmethod
    def handle(router: APIRouter) -> None:
        @router.post(
            '/analyses/{analysis_id}/petition-drafts/regenerate', status_code=202
        )
        async def _(
            body: _Body,
            analysis: Annotated[
            ...
            use_case = TriggerPetitionDraftRegenerationUseCase(
