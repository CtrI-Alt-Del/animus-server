...
class PetitionSummaryTest:
    ...
    relevant_laws: ClassVar[list[Text]] = [
    ...
    search_terms: ClassVar[list[Text]] = [
...
class SearchAnalysisPrecedentsUseCase:
    ...
    def _extract_lexical_profile(  # noqa: C901
        self,
        ...
        # 4) domain_anchors: termos especificos do dominio do caso -
