...
class TestRemoveAnalysisPrecedentController:
    def test_should_return_200_and_remove_only_requested_precedent(
        self,
        client: TestClient,
        ...
        assert second_precedent is None
    ...
    def test_should_return_422_when_number_query_param_is_missing(
        ...
        response = client.delete(
            f'/intake/analyses/{ULID()!s}/precedents',
            params={
                'court': 'STF',
                'kind': 'RG',
            },
