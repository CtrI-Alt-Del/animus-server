...
def _create_analysis_with_chosen_precedents(
...
class TestUnchooseAnalysisPrecedentController:
    def test_should_return_200_and_unchoose_only_requested_precedent(
        self,
        client: TestClient,
        ...
        analysis_id, first_precedent_id, second_precedent_id = (
            _create_analysis_with_chosen_precedents(
        ...
        response = client.patch(
            f'/intake/analyses/{analysis_id}/precedents/unchoose',
            params={
                'court': 'STF',
                'kind': 'RG',
                'number': 202,
        ...
        assert second_precedent.is_chosen is False
    ...
    def test_should_return_422_when_number_query_param_is_missing(
        ...
        response = client.patch(
            f'/intake/analyses/{ULID()!s}/precedents/unchoose',
            params={
                'court': 'STF',
                'kind': 'RG',
            },
