...
from animus.core.intake.use_cases import RemoveAnalysisPrecedentUseCase
from animus.core.shared.domain.structures import Id
from animus.core.shared.responses import ListResponse


class TestRemoveAnalysisPrecedentUseCase:
    ...
    def test_should_remove_precedent_when_identifier_exists(self) -> None:
        ...
        self.analysis_precedents_repository_mock.remove_by_analysis_id_and_precedent_id.assert_called_once_with(
