...
class TestArchiveAnalysisUseCase:
    ...
    def setup(self) -> None:
        ...
        self.use_case = ArchiveAnalysisUseCase(
            analisyses_repository=self.analisyses_repository_mock,
        )

    def test_should_archive_analysis_idempotently_and_persist_it(self) -> None:
        analysis = _make_analysis(is_archived=True)
