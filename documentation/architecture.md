...
- `GET /intake/analyses` -> `ListAnalysesController` -> `AuthPipe` / `DatabasePipe` -> `ListAnalysesUseCase` -> `AnalysesRepository` -> PostgreSQL (`analyses`) -> `CursorPaginationResponseSchema[AnalysisDto]`.
- `GET /intake/analyses/{analysis_id}` -> `GetAnalysisController` -> `AuthPipe` / `DatabasePipe` -> `GetAnalysisUseCase` -> `AnalysesRepository` -> PostgreSQL (`analyses`) -> `AnalysisDto`.
- `PATCH /intake/analyses/{analysis_id}/name` -> `RenameAnalysisController` -> `AuthPipe` / `DatabasePipe` -> `RenameAnalysisUseCase` -> `AnalysesRepository` -> PostgreSQL (`analyses`) -> `AnalysisDto`.
- `PATCH /intake/analyses/archive` -> `ArchiveAnalysesController` -> `AuthPipe` / `DatabasePipe` -> `ArchiveAnalysesUseCase` -> `AnalysesRepository` -> PostgreSQL (`analyses`) -> `list[AnalysisDto]`.
- `PATCH /intake/analyses/folder` -> `MoveAnalysesToFolderController` -> `AuthPipe` / `DatabasePipe` -> `MoveAnalysesToFolderUseCase` -> `AnalysesRepository` / `FoldersRepository` -> PostgreSQL (`analyses`, `folders`) -> `list[AnalysisDto]`.
- `POST /intake/analyses/{analysis_id}/case-assessment-briefing` -> `CreateCaseAssessmentBriefingController` -> `IntakePipe.verify_analysis_by_account_from_request(...)` -> `CreateCaseAssessmentBriefingUseCase` -> `CaseAssessmentBriefingsRepository` / `CaseSummariesRepository` / `AnalysesRepository` -> PostgreSQL (`case_assessment_briefings`, `case_summaries`, `analyses`) -> `CaseAssessmentBriefingDto`.
- `POST /intake/petitions` -> `CreatePetitionController` -> `AuthPipe` / `IntakePipe.verify_analysis_by_account(...)` -> `CreatePetitionUseCase` -> `PetitionsRepository` / `AnalysesRepository` / `Broker` -> PostgreSQL (`petitions`, `petition_summaries`, `analyses`) -> `PetitionDto`.
...
- `POST /intake/analyses/{analysis_id}/document` -> `CreateAnalysisDocumentController` -> `AuthPipe` / `DatabasePipe` / `PubSubPipe` -> `CreateAnalysisDocumentUseCase` -> `AnalysisDocumentsRepository` / `AnalysesRepository` / `Broker` -> PostgreSQL (`analysis_documents`, `analyses`) -> `AnalysisDocumentDto`.
- `GET /intake/analyses/{analysis_id}/document` -> `GetAnalysisDocumentController` -> `IntakePipe.verify_analysis_by_account_from_request(...)` -> `GetAnalysisDocumentUseCase` -> `AnalysisDocumentsRepository` -> PostgreSQL (`analysis_documents`) -> `AnalysisDocumentDto`.
- `POST /intake/analyses/{analysis_id}/case-summaries` -> `RequestCaseSummaryController` -> `IntakePipe.verify_analysis_by_account_from_request(...)` -> `RequestCaseSummaryUseCase` -> `AnalysisDocumentsRepository` / `AnalysesRepository` / `Broker` -> `CaseSummaryCaseSummarizationTriggeredEvent` ou `SecondInstanceCaseSummarizationTriggeredEvent`, conforme `Analysis.type`.
- `POST /intake/analyses/{analysis_id}/case-summary` -> `TriggerCaseAssessmentCaseSummarizationController` -> `IntakePipe.verify_analysis_by_account_from_request(...)` -> `TriggerCaseAssessmentCaseSummarizationUseCase` -> `CaseAssessmentBriefingsRepository` / `AnalysesRepository` / `Broker` -> `CaseAssessmentCaseSummarizationTriggeredEvent`.
- `GET /intake/analyses/{analysis_id}/case-summaries` -> `GetCaseSummaryController` -> `IntakePipe.verify_analysis_by_account_from_request(...)` -> `GetCaseSummaryUseCase` -> `CaseSummariesRepository` -> PostgreSQL (`case_summaries`) -> `CaseSummaryDto`.
...
- `PATCH /intake/analyses/{analysis_id}/precedents/choose` -> `ChooseAnalysisPrecedentController` -> `IntakePipe.verify_analysis_by_account_from_request(...)` -> `ChooseAnalysisPrecedentUseCase` -> `AnalysisPrecedentsRepository` / `AnalysesRepository` -> PostgreSQL (`analysis_precedents`, `analyses`) -> `AnalysisStatusDto`.
- `POST /intake/analyses/{analysis_id}/petition-drafts` -> `TriggerPetitionDraftGenerationController` -> `IntakePipe.verify_analysis_by_account_from_request(...)` -> `TriggerPetitionDraftGenerationUseCase` -> `AnalysesRepository` / `CaseSummariesRepository` / `AnalysisPrecedentsRepository` / `Broker` -> `PetitionDraftGenerationTriggeredEvent`.
- `GET /intake/analyses/{analysis_id}/petition-drafts` -> `GetPetitionDraftController` -> `AuthPipe` / `DatabasePipe` -> `GetPetitionDraftUseCase` -> `AnalysesRepository` / `PetitionDraftsRepository` -> PostgreSQL (`analyses`, `petition_drafts`) -> `PetitionDraftDto`.
- `GET /intake/analyses/{analysis_id}/case-assessment-report` -> `GetCaseAssessmentAnalysisReportController` -> `AuthPipe` / `DatabasePipe` -> `GetCaseAssessmentAnalysisReportUseCase` -> `AnalysesRepository` / `CaseAssessmentBriefingsRepository` / `AnalysisDocumentsRepository` / `CaseSummariesRepository` / `AnalysisPrecedentsRepository` / `PetitionDraftsRepository` -> PostgreSQL (`analyses`, `case_assessment_briefings`, `analysis_documents`, `case_summaries`, `analysis_precedents`, `petition_drafts`) -> `CaseAssessmentAnalysisReportDto`.
- `GET /intake/analyses/{analysis_id}/first-instance-report` -> `GetFirstInstanceAnalysisReportController` -> `AuthPipe` / `DatabasePipe` -> `GetFirstInstanceAnalysisReportUseCase` -> `AnalysesRepository` / `AnalysisDocumentsRepository` / `CaseSummariesRepository` / `AnalysisPrecedentsRepository` / `SecondInstanceJudgmentDraftsRepository` -> PostgreSQL (`analyses`, `analysis_documents`, `case_summaries`, `analysis_precedents`, `judgment_drafts`) -> `FirstInstanceAnalysisReportDto`.
...
- `CaseAssessmentCaseSummarizationTriggeredEvent` -> `SummarizeCaseAssessmentCaseJob` -> `CaseAssessmentBriefingsRepository` / `AnalysisDocumentsRepository` / `GetDocumentContentUseCase` -> `AgnoSummarizeCaseAssessmentCaseWorkflow` com briefing + documentos opcionais -> `CreateCaseSummaryUseCase` / `CaseSummaryFinishedEvent` com `analysis_type`.
