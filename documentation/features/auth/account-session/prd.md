...
- [x] Cadastro via e-mail e senha
  - Valor entregue: o backend cria a conta, persiste a senha com hash, envia o fluxo de verificacao por e-mail e permite reenviar o link quando necessario.
...
- O app ja consegue concluir o fluxo principal de acesso do usuario por cadastro manual, verificacao de e-mail, login por e-mail e senha e login com Google.
