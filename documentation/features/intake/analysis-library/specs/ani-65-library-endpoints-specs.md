...
- **`Analysis`** (`src/animus/core/intake/domain/entities/analyses.py`) - entidade ja integrada a `folder_id`, o que confirma o vinculo funcional entre analise e pasta.
