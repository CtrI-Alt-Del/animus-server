...
- **Plano no contexto** (se houver): `*-plan.md` derivado desta spec.
...
Adicione (ou acrescente linha) logo após o frontmatter:
...
| Data | Seções | Motivo
|---|---|---|---|
| YYYY-MM-DD | #6, #7 | DTO renomeado após conflito com model existente
```
...
**2.6 Impacto no plano** *(quando plano existir)*
...
- Não remova entradas do histórico de alterações.
