...
- Interação com dependencia externa (ex.: `assert_called_once_with`).
...
- Nao validar detalhes internos irrelevantes de implementação.
...
- um teste de erro/regra de exceção.
...
5. Cenario de erro validando exceção de dominio + chamada de dependencia.
